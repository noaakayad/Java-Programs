...
public class MainFigure {
	...
	public static void main(String[] args) {
        ...
        Point p1 = new Point(6,7,draw);
        Point p2 = new Point(5,2,draw);
        Point p3 = new Point(25,25,draw);
        //point p4 = new Point(90,90);
        Circle c1 = new Circle(p1,-10,draw);
        Circle c2 = new Circle(p1,150,draw);
        Circle c3 = new Circle(p2,10,draw);
        Circle c4 = new Circle(p3,100,draw);
